...
<body>
    <form name="edit-user-form" action ="update_user.php" method="post">
        <input type="hidden" name="iduser" value="<?php echo $user_id?>" readonly
        required/><br><br>
        <label>Identification numbber:</label><input type="text" name="idenumber" value="<?php echo $ide_number?>" readonly
        required/><br><br>
        <label>Firstname </label><input type="text" name="fname" value="<?php echo $fname?>"
        required/><br><br>
